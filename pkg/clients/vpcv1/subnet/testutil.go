...
var (
	...
	networkACLID                 = ibmc.RandomString(false)
	...
	publicGatewayID              = ibmc.RandomString(false)
	...
	routingTableID               = ibmc.RandomString(false)
